...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 23-Nov-2023 às 13:17
...
(5, 'Marcelino percebe que o fogo esta incontrolável e decide sair da biblioteca o mais rápido possível. Após sair do local, ele se depara com o caos na cidade durante o ataque de Júlio Cesar. Então Marcelino tem a ideia de fugir para o porto, mas ele vê um grupo de estudantes procurando refugio.', 'alexandria-antiga.jpg'),
...
(10, 'Marcelino decide ir para o porto para tentar fugir do caos. Ele consegue entrar em um navio que parte para o Mar Mediterrâneo, porém ele tem a escolha de ir para o noroeste ou para o oeste. ', 'porto-alexandria.jpg'),
...
(22, 'Marcelino se envolve profundamente na reconstrução da nova biblioteca em Alexandria. Ele está determinado a preservar o conhecimento e fazer uma contribuição significativa. Infelizmente, ocorre um incêndio acidental na nova biblioteca, pois o material utilizado na sua construção era de fácil combustão. O fogo se alastrou mais rápido porque havia muitos pergaminhos de papel, sem dar chances de fuga a quem estava por perto. Marcelino é pego nas chamas enquanto tenta salvar manuscritos valiosos. Ele perece heroicamente no incêndio, sua dedicação ao conhecimento o faz perder a vida.', 'construcao.jpg'),
